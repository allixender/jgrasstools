...
public class GeneratorZoo {
    ...
    public static void generate() throws IOException {
        ...
        File configFolderFile = new File("./src/main/resources");
        if (!configFolderFile.exists()) {
            throw new IOException("Resources folder doesn't exist: " + configFolderFile.getAbsolutePath());
        }
         ...
         * - FileIterator
         *
         * TODO Also problematic, others with List input
         * - MapCalc
         */
        List<String> skipModules = Arrays.asList(new String[]{"RasterReader", "RasterWriter", "VectorReader", "VectorWriter", "FileIterator"});
        ...
        for( String className : allClasses ) {
            ...
            String newClassCanonicalName = "org.jgrasstools.wps.zoo." + className + "Wps";
            if (doInDefaultPackage) {
            ...
            if (!doInDefaultPackage)
                sb.append("package org.jgrasstools.wps.zoo; \n");
            sb.append(" \n");
