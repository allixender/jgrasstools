...
import org.jgrasstools.modules.ScanLineRasterizer; 
 
@Algorithm(version = "1.0.0", abstrakt = "Module for polygon vector to raster conversion.")
public class ScanLineRasterizerAlgorithm extends AbstractAnnotatedAlgorithm { 

  static final Logger logger = LoggerFactory.getLogger(ScanLineRasterizerAlgorithm.class); 

  public ScanLineRasterizerAlgorithm() { 
    super();
  }
  ...
  @LiteralDataInput(identifier = "inVector", abstrakt = "The vector to rasterize.", minOccurs = 1, maxOccurs = 1, binding = LiteralStringBinding.class)
  ...
  @LiteralDataInput(identifier = "pValue", abstrakt = "The value to use as raster value if no field is given.", minOccurs = 1, maxOccurs = 1, binding = LiteralDoubleBinding.class)
  ...
  @LiteralDataInput(identifier = "fCat", abstrakt = "The field to use to retrieve the category value for the raster.", minOccurs = 1, maxOccurs = 1, binding = LiteralStringBinding.class)
  ...
  public void runAlgorithm() throws Exception { 
    logger.info("org.jgrasstools.wps.n52.ScanLineRasterizerAlgorithm");
    
    ScanLineRasterizer tmpModule = new ScanLineRasterizer(); 
