...
import org.jgrasstools.modules.RasterVectorIntersector; 
 
@Algorithm(version = "1.0.0", abstrakt = "Module for raster with polygon vector intersection.")
public class RasterVectorIntersectorAlgorithm extends AbstractAnnotatedAlgorithm { 

  static final Logger logger = LoggerFactory.getLogger(RasterVectorIntersectorAlgorithm.class); 

  public RasterVectorIntersectorAlgorithm() { 
    super();
  }
  ...
  @LiteralDataInput(identifier = "inVector", abstrakt = "The polygon vector to use for the intersection.", minOccurs = 1, maxOccurs = 1, binding = LiteralStringBinding.class)
  ...
  @LiteralDataInput(identifier = "inRaster", abstrakt = "The raster to use for the intersection.", minOccurs = 1, maxOccurs = 1, binding = LiteralStringBinding.class)
  ...
  @LiteralDataInput(identifier = "doInverse", abstrakt = "Flag to use to invert the result (default is false = keep data inside vector)", minOccurs = 1, maxOccurs = 1, binding = LiteralBooleanBinding.class)
  ...
  public void runAlgorithm() throws Exception { 
    logger.info("org.jgrasstools.wps.n52.RasterVectorIntersectorAlgorithm");
    
    RasterVectorIntersector tmpModule = new RasterVectorIntersector(); 
