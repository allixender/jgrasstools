...
import org.jgrasstools.modules.VoronoiDiagram; 
 
@Algorithm(version = "1.0.0", abstrakt = "Creates a Voronoi diagram from a set of points.")
public class VoronoiDiagramAlgorithm extends AbstractAnnotatedAlgorithm { 

  static final Logger logger = LoggerFactory.getLogger(VoronoiDiagramAlgorithm.class); 

  public VoronoiDiagramAlgorithm() { 
    super();
  }
  ...
  @LiteralDataInput(identifier = "outMap", abstrakt = "The output voronoi map.", minOccurs = 1, maxOccurs = 1, binding = LiteralStringBinding.class)
  ...
  @LiteralDataOutput(identifier = "res_outMap", abstrakt = "The output voronoi map.", binding = LiteralStringBinding.class)
  ...
  public void runAlgorithm() throws Exception { 
    logger.info("org.jgrasstools.wps.n52.VoronoiDiagramAlgorithm");
    
    VoronoiDiagram tmpModule = new VoronoiDiagram(); 
