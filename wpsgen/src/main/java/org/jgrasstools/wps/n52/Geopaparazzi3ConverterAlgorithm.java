...
import org.jgrasstools.modules.Geopaparazzi3Converter; 
 
@Algorithm(version = "1.0.0", abstrakt = "Converts a geopaparazzi 3 project folder into shapefiles.")
public class Geopaparazzi3ConverterAlgorithm extends AbstractAnnotatedAlgorithm { 

  static final Logger logger = LoggerFactory.getLogger(Geopaparazzi3ConverterAlgorithm.class); 

  public Geopaparazzi3ConverterAlgorithm() { 
    super();
  }
  ...
  @LiteralDataInput(identifier = "inGeopaparazzi", abstrakt = "The geopaparazzi folder", minOccurs = 1, maxOccurs = 1, binding = LiteralStringBinding.class)
  ...
  public void runAlgorithm() throws Exception { 
    logger.info("org.jgrasstools.wps.n52.Geopaparazzi3ConverterAlgorithm");
    
    Geopaparazzi3Converter tmpModule = new Geopaparazzi3Converter(); 
